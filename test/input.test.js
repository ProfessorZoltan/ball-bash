...
import { spinToTurn, travelSpin, MOUSE_SENS, WHEEL_STEP, MOUSE_TURN_RATE, SPIN_BACKLOG } from '../src/input.js';
...
test('mouse travel: right and back turn clockwise, left and forward counter-clockwise, and the two add up', () => {
