...
export const LEVEL_DEFS = [
  {
    ...
    opening: [
      ...
      ['sign', { text: say('Aim with the MOUSE or the ARROWS · hold LEFT CLICK or / for the targeting line, let go to fire', 'Aim with the RIGHT STICK · hold RT for the targeting line, let go to fire') }],
      ...
      ['sign', { text: say('Hold Q or E to aim a wormhole end, let go to open it · walk into one, out of the other', 'Hold LB or RB to aim a wormhole end, let go to open it · walk into one, out of the other') }],
